    ...
    function getAnime(animeid){
        GM.xmlHttpRequest({
            ...
            onload: function(response) {
                ...
                let epView = document.createElement('div');
                if(number_of_episodes > 1){
                    epView = create_episode_view(html.getElementById('stafflist'), number_of_episodes);
                ...
                button_container.id = "staff-buttons"

                document.getElementsByClassName("detail-characters-list")[1].appendChild(button_container);
                document.getElementById("staff-buttons").appendChild(anidbstaffDiv);
                document.getElementById("staff-buttons").appendChild(epView);
